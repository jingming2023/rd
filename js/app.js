...
const PRELOAD = {
  'little-prince':{
    title:'小王子',author:'圣-埃克苏佩里',genre:'名著',cover:'🌟',desc:'全球销量仅次于圣经的童话，被翻译成300多种语言。',wordCount:3150,license:'public_domain',
    zh:[
  ...
  'border-town':{
    title:'边城',author:'沈从文',genre:'名著',cover:'🏔️',desc:'沈从文代表作。以湘西小城茶峒为背景，讲述翠翠与傩送的纯美爱情。中国现代文学最唯美的中篇小说。',wordCount:2950,license:'pending',
    zh:[
  ...
  'doupo':{
    title:'斗破苍穹',author:'天蚕土豆',genre:'网文',cover:'🔥',desc:'中国网络文学史上最具影响力的玄幻小说。天才少年萧炎从云端跌落谷底后逆天改命的热血故事。"三十年河东，三十年河西，莫欺少年穷！"',wordCount:3100,license:'pending',
    zh:[
  ...
  'quanzhi':{
    title:'全职高手',author:'蝴蝶蓝',genre:'网文',cover:'🎮',desc:'电竞题材网络小说的巅峰之作。荣耀教科书级高手叶修被俱乐部驱逐后，重新组建战队重返巅峰。"如果喜欢，就把这一切当作是荣耀，而不是炫耀。"',wordCount:3050,license:'pending',
    zh:[
  ...
  'neural-net':{
    ...
    desc:'AI到底是如何诞生的？人工神经网络如何模拟人脑实现智能？一篇通俗易懂的科普。',wordCount:3150,license:'open',
    zh:[
  ...
  'climate-change':{
    ...
    desc:'过去百年全球升温0.74℃。温室效应如何发生？海平面上升有多严重？我们能做什么？',wordCount:3200,license:'open',
    zh:[
...
async function renderLib(){
  let books=Object.entries(PRELOAD)
    .filter(([id,b])=>b.license!=='pending')  // 版权合规：过滤受版权保护的书
    .map(([id,b])=>({id,...b}));
  ...
  if(db){
    ...
    if(online){
      hideOfflineBanner();
      // 从Supabase加载用户上传的书籍（也过滤 pending）
      try{
        const{data}=await db.from('books').select('*').neq('license','pending');
